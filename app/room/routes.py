...
from app.core.deps.service import get_room_service
from app.exceptions import ConflictError, NotFoundError
from app.room.schemas import RoomRead, RoomCreate, RoomUpdate
...
async def get_room_by_id(
    ...
    try:
        return await service.get_by_id(room_id=room_id)
